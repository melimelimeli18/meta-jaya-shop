        ...
        <div className="col-md-8">
          ...
          <div className="bg-light rounded-3 p-3 mt-4 text-center">
            <small className="text-muted">
              ...
              dijadikan unggulan. Centang checkbox untuk menampilkan produk di
              halaman utama sebagai produk unggulan. Produk yang dicentang akan
              muncul di section &quot;Produk Unggulan&quot; pada halaman user.
            </small>
          </div>
