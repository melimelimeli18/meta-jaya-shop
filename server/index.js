...
app.get("/", (req, res) => {
  res.json({
    ...
    notes: {
      autoGeneratedId:
        "Product ID is auto-generated by database trigger. Don't include 'id' field in POST requests.",
      requiredFields: ["name", "price", "category", "link"],
      optionalFields: ["description", "image", "sold"],
      urlValidation: "Fields 'link' and 'image' must be valid URLs",
      bulkOperations:
        "Use bulk endpoints for better performance when working with multiple products",
      safetyConfirm:
        "DELETE /api/products/filter requires 'confirm: true' in request body",
    },

    links: {
      documentation: "/api",
      github: "https://github.com/yourusername/products-api",
